...
If you find an error, that is the system working as described; the whole design is about paying for error correction. Until the machinery in [chapter 3](03-market.md) exists to pay you properly, consider filing an issue at [libdither/dither-spec](https://github.com/libdither/dither-spec) an act of unpaid forecasting.
