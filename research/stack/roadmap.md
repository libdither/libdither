...
| 5 | Governance / truth machine | Retroactive consensus markets + hierarchical liquid quadratic voting ([Retroactive Consensus Markets](03-market.md)); [applications/protocol-of-truth](../applications/protocol-of-truth/protocol-of-truth.md) | **Rigorous mechanism synthesis now in repo**; central theory gap (reflexivity) reduced to a measurable threshold ([mathematical-core.md](mathematical-core.md) §2). |
...
- ~~The truth-markets notes live outside this repo and should be merged as a spec chapter.~~ **Done** — merged as [Retroactive Consensus Markets](03-market.md) (mechanism, assumptions A1–A5, open problems §8).
...
- ✅ Merge truth-markets notes into this spec (`governance/` chapter): mechanism, assumptions A1–A5, open problems — see [Retroactive Consensus Markets](03-market.md).
