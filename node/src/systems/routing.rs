...
use crate::{Network, NetworkCoord, NodeID, NodeSystem, Remote};
...
fn establish_traversal_session(
    mut commands: Commands,
    requests: Query<(Entity, &Remote, &TraversalSessionRequest), Without<TraversalSession>>,
) {
